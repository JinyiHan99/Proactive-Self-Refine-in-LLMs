...
import random
import re
input_file = "/data2/WangXinyi/refine/datasets/xsum/test.jsonl"
output_file = "/data2/WangXinyi/refine/datasets/xsum/test_select313.jsonl"
sample_size = 313
...
raw_jsons = re.findall(r'\{(?:"id":.*?)}', content, flags=re.DOTALL)
